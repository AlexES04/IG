...
A continuación, se muestra una imagen del proyecto y un [enlace a youtube](https://youtu.be/hXEyirP-O9Q) para la visualización de una demo.
...
## Funcionalidades
El proyecto integra unas pocas funcionalidades visuales y físicas gracias a la inclusión de las tecnologías mencionadas más adelante. Se destacan las siguientes:
...
- [Modelo de admirante pirata](https://www.cgtrader.com/items/6091558/download-page)
